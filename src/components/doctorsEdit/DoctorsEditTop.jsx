...
const DoctorsEditTop = ({title}) => {
  return (
    <main className="flex flex-col lg:flex-row justify-between  p-3">
      ...
      <div className="flex items-center ml-auto"> {/* ml-auto pushes the content to the right end */}
        <button className="flex items-center border border-primaryColor mr-8 p-2 rounded-lg">
