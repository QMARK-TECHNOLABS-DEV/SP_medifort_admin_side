...
function HealthTalkPage() {
    const contentItems = [
        { imageSrc: content1, title: 'Article' },
        { imageSrc: content2, title: 'Video' },
        { imageSrc: content3, title: 'Research' },
      ...
      return (
        <div className="h-screen w-full overflow-hidden"> 
          <div className="flex-1 h-full pb-32 overflow-y-auto"> 
            <h1 className="text-4xl text-left font-semibold mb-6">Health Talk</h1>
