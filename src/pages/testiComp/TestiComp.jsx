...
const TestiComp = () => {
  ...
  const handleEditSubmit = (e) => {
    e.preventDefault();
    setVideos(videos.map(video => (video.id === currentVideo.id ? currentVideo : video)));
    setIsEditing(false);
  };
  ...
  return (
    <div className="p-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
        {videos.map((video) => (
          <div key={video.id} className="rounded-lg overflow-hidden shadow-lg bg-white border border-blue-200">
            ...
            <div className="flex justify-between items-center px-6 py-4">
              ...
              <span className="flex-grow"></span> {/* This will push the date to the right */}
