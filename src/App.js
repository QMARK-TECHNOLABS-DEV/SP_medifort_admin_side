        ...
        <Route element={<AdminGuard />}>
          <Route element={<MainLayout />}>
            ...
            <Route
              ...
              element={<TestimonialsPatientContentPage />}
            />
            ...
            />
            <Route
              path="/content-management/preventive-health"
            ...
            {/* Health Talk */}
            <Route
              path="/content-management/health-talk"
              element={<HealthTalkPage />}
            />
            <Route
            ...
            />
            <Route
              path="/content-management/article/new-article"
              element={<NewArticlePage />}
            />
            <Route path="/content-management/video" element={<VideoPage />} />
            <Route
              path="/content-management/brochure"
              element={<BrochurePage />}
            />

            {/* Research */}
            <Route
              path="/content-management/research"
              element={<ResearchPage />}
            />
            <Route
              path="/content-management/research/new-research"
              element={<NewResarchPage />}
            />

            {/* News */}
            <Route path="/content-management/news" element={<NewsPage />} />
            <Route
              path="/content-management/news/new-news"
              element={<AddNewsPage />}
            />
            ...
            <Route
              path="/content-management/blog/new-blog"
              element={<AddBlogPage />}
            />
            {/* Specialties */}
            <Route
              path="/content-management/specialities"
              element={<SpecialtiesPage />}
            />
            <Route
              path="/content-management/specialities/new-speciality"
              element={<AddSpecialitiesPage />}
            />

            {/* Case Studies */}
            <Route
              path="/content-management/casestudies"
              element={<CaseStudyHomePage />}
            />

            {/* Gallery Crud */}
            <Route
              path="/content-management/media/gallery"
              element={<Gallery />}
            />
            <Route
              path="/content-management/media/video"
              element={<MediaVideoPage />}
            />
            ...
            <Route
              path="/enquiry/insurance"
              element={<InsuranceEnquiryPage />}
            />
            <Route path="/enquiry/feedback" element={<FeedbackEnquiryPage />} />
            <Route
              path="/enquiry/contact-us"
              element={<ContactUsEnquiryPage />}
            />
            <Route
              path="/enquiry/international-patient-enquiry"
              element={<InternationalPatientEnquiryPage />}
            />
